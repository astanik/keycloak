...
@NamedQueries({
        ...
        @NamedQuery(name= "deleteBrokerLinkByRealmAndLink", query="delete from BrokerLinkEntity social where social.userId IN (select u.id from UserEntity u where u.realmId=:realmId and u.federationLink=:link)"),
